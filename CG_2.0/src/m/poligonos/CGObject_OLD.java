 ...
 * @author JFPS
 */
public abstract class CGObject_OLD implements Serializable{
    ...
    protected CGObject_OLD(int numberOfPoints){ 
        this.ID = INSTANCES++;
        pointMatrix = new float [4][numberOfPoints];
    }
    
    protected CGObject_OLD(long ID, int numberOfPoints){ 
        this.ID = ID;
        pointMatrix = new float [4][numberOfPoints];
    }
    
    protected CGObject_OLD(float[][] pointMatrixCp, long ID) {
        this.ID = ID;
    ...
    protected CGObject_OLD(float[][] pointMatrix) {
    ...
    public boolean equals(Object obj) {
        ...
        final CGObject_OLD other = (CGObject_OLD) obj;
