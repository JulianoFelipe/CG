 ...
 * @author JFPS
 */
public class GouraudZbuffer extends CGShader{
    ...
    public GouraudZbuffer(Vertice observador, AmbientLight luzAmbiente) {
        super(observador, luzAmbiente);
    }
    
    public GouraudZbuffer(Vertice observador, AmbientLight luzAmbiente, List<PointLight> luzesPontuais) {
    ...
    public void shade(List<CGObject> objetosSRT, GraphicsContext graphs, long selectedID, Color selectedColor) {
        ...
        int width  = (int) graphs.getCanvas().getWidth();
        int height = (int) graphs.getCanvas().getHeight();
